...
import { updatePurchase } from "../api/PurchaseOrderBD";
...
type RouteParams = {
  ...
  const UpdatePurchase = () => {
    ...
    const { purchase } = route.params as RouteParams;
  
    const handleUpdateAuthority = async () => {
      await updatePurchase(purchase.id, documentNumber, date);
    ...
    return (
      <View>
        <ContainerBars/>
         ...
         <Text style={styles.title}>Update Authority</Text>
          <View style={styles.container}>
          <Text style={styles.label}>Name:</Text>
          <TextInput
            style={styles.input}
            value={documentNumber || purchase.documentNumber}
          ...
          <Button title="Guardar" onPress={handleUpdateAuthority} />
